...
var JSON2CSVBase = function () {
  ...
  createClass(JSON2CSVBase, [{
    ...
    value: function flatten(dataRow) {
      function step(obj, flatDataRow, currentPath) {
        Object.keys(obj).forEach(function (key) {
          ...
          if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) !== 'object' || Array.isArray(value) || Object.prototype.toString.call(value.toJSON) === '[object Function]' || !Object.keys(value).length) {
    ...
    value: function unwindData(dataRow, unwindPaths) {
      return Array.prototype.concat.apply([], unwindPaths.reduce(function (data, unwindPath) {
        return Array.prototype.concat.apply([], data.map(function (dataEl) {
...
var JSON2CSVParser = function (_JSON2CSVBase) {
  ...
  createClass(JSON2CSVParser, [{
    ...
    value: function parse(data) {
      ...
      if (!this.opts.fields) {
        var dataFields = Array.prototype.concat.apply([], processedData.map(function (item) {
    ...
    value: function preprocessData(data) {
      ...
      if (processedData.length === 0 || _typeof(processedData[0]) !== 'object') {
        throw new Error('Data should not be empty or the "fields" option should be included');
      }

      return Array.prototype.concat.apply([], processedData.map(function (row) {
